...
// function total(arr) {
//     arr = arr.reduce((val1, val2) => val1 + val2)
//     return arr
// }

// console.log(total([1, 2, 3, 4, 10])); // 20

// // 2) Turn an array of numbers into a long string of all those numbers.
// function stringConcat(arr) {
//     arr = arr.reduce((val1, val2) => val1.toString() + val2.toString())
//     // arr = arr.join("") //Just using join("") would be easier, but the reduce solution is actually faster. 
//     return arr
// }
// console.time()
// console.log(stringConcat([7, 9, 8, 8, 5])); // "123"
// console.timeEnd()
...
//     let total = arr.reduce(function(counter, key){
//         // console.log(counter, key.price)
//         return counter + key.price
...
//     let finalArr = arr.reduce(function(counter, item){
//         return counter.concat(item)
//     })
//     return finalArr
// }
